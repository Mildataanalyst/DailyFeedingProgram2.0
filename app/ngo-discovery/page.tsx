...
const pathwayOptions = [
  ...
  { key: 'sports_arts_stem_vocational', label: 'Sports / arts / STEM / niche pathways', note: 'Sports, drama, music, arts, STEM and serious cohort pathways. Vocational only where it is a real adolescent pathway.' },
